...
DiagrammeR::grViz("digraph {
  ...
  ZeeSpSt [label = 'Zeespiegel \n stijging']
  Glet [label =  'Gletsjers']
  OvWater [label = 'Overig \n watermassa']
  Morf [label = 'Morfologie']
  Tect [label = 'Tectoniek/GIA']
  Winning [label = 'Winning']
  Wind [label = 'Wind']
  Zoet [label = 'Zoete afvoer']
  ...
  RegZS->LokRelZS  Tect->BodDal Winning-> BodDal BodDal->LokRelZS  
  Wind->Opzet Opzet->LokRelZS  Morf-> Getij Getij->LokRelZS ZeeSpSt->Getij Morf->Opzet ZeeSpSt->Opzet Zoet->Opzet
  
  }",
  width = 650, height = "450px")
