...
We lopen langs de verschillende onderdelen van de resultaten, en maken een vergelijking met wat anderen rapporteren over de Nederlandse zeespiegel. Ook proberen we de verschillen binnen Nederland te duiden. 

## Windopzetcorrectie {#sec-winsopzetcorrectie}

De windopzet wordt berekend met het \acr{GTSM} (zie paragraaf \@ref(sec-windopzet)). Vergeleken met de vorige rapportage in 2022 zijn de berekeningen met het \acr{GTSM} uitgebreid met de jaren 2022-2025, maar ook voor de eerdere jaren 1950-1978. Hierdoor is er nu een ruim 70 jaar lange serie voor berekende windopzet.

Voor de correctie van de zeespiegel voor windopzet wordt een gemiddelde opzet gebruikt voor de periode voor 1950, en de (jaargemiddelde) afwijking van het langjarig gemiddelde voor de periode vanaf 1950 (figuur \@ref(fig:gtsm-opzet)). De correctie zorgt dus alleen voor een kleinere variatie, maar heeft geen invloed op de gemiddelde zeespiegel.

![Windopzet langs de Nederlandse kust uitgedrukt als afwijking van het langjarige gemiddelde. De berekeningen hiervoor zijn gedaan met GTSM.](https://github.com/Deltares-research/sealevelmonitor/raw/develop_reporting26_willem/analysis/sealevelmonitor/10_sealevelanalysis_files/figure-gfm/gtsm-surge-anomalie-1.png)
...
Op basis van de gegevens over alle jaren, inclusief de meest recente t/m 2025, en met gebruik van het voorkeursmodel zijn vanuit de gemeten waterhoogte en de afwijking van de windopzet van het gemiddelde bepaald:

- de trend over de afgelopen jaren
- het nodaal getij
- het residu, dat wil zeggen het onverklaarde deel van de variatie in de metingen. 

![Gemeten zeespiegel, voor windopzet gecorrigeerde waarden, en de trend met gebruik van het voorkeursmodel, een gebroken lineair model. ](https://github.com/Deltares-research/sealevelmonitor/raw/develop_reporting26_willem/analysis/sealevelmonitor/20_sealevelmonitor_files/figure-gfm/unnamed-chunk-6-1.png}
...
De bijdragen van windopzet, nodaal getij en het residu aan de variatie in de gemeten waterhoogte zijn alle drie in dezelfde ordegrootte. 


![Gemeten zeespiegel (height), trend (fitted_total) en de bijdragen van de verschillende processen in het verloop van de zeespiegel in de tijd. De onderste drie lijnen zijn getransformeerd zodat ze beter te zien zijn. In werkelijkheid zijn dit afwijkingen van de nullijn. ](https://github.com/Deltares-research/sealevelmonitor/raw/main/analysis/sealevelmonitor/20_sealevelmonitor_files/figure-gfm/partials-1.png){#fig-huidige-zeespiegel}

Opvallend was dat de gemeten zeespiegel twee jaar op rij (namelijk in 2023 en 2024) ruim boven de verwachte zeespiegel (bruine lijn) lag. Dit was nog niet eerder gebeurd in de periode vanaf 1950. In 2025 was dit weer niet het geval. Dit is van belang, omdat een grote afwijking van metingen ten opzichte van het model, vooral in de "uiteinden", erop kan wijzen dat het gebruikte model moet worden herzien. Op dit moment zie we daar nog geen aanleiding toe. 

| jaar | zeespiegel in mm (NAP2005) |
|-----:|-------------:|
| 2025 |        112.4 |
| 2024 |        161.4 |
| 2023 |        152.8 |
...
Het nodaal getij wordt samen met de trend (en het residu) berekend uit de waterhoogtegevens (zie paragraaf \@ref(sec-modelkeuze)). De amplitude wordt geschat op .. mm. In 2025 is het nodaal getij net over een maximum heen, en dus aan het afnemen. De verwachting is dan ook dat de komende jaren weer een iets lagere gemeten zeespiegel zullen laten zien vergeleken met de afgelopen pakweg 5 jaar. 

## Residu

Het residu in figuur is de variatie die overblijft wanneer de windopzetanomalie, het nodaal getij en de trendlijn zijn afgetrokken van de gemeten waterhoogtes. Het is te zien dat de variatie van het residu kleiner is over de periode waar jaarlijkse windopzet beschikbaar is (vanaf 1950). 
