...
In paragraaf \@ref(sec-....) wordt uitgelegd hoe we tot een voorkeursmodel komen om de huidige stijging van de zeespiegel zo goed mogelijk te beschrijven. De berekeningen voor deze keuze staan in een [online rekendocument](link-naar-rekendocument-analyse). Dit jaar is, net als in de vorige rapportage, het gebroken lineaire model het best passende model. Een aanname daarbij is dat de zeespiegel vanaf het begin van de jaren '90 sneller is gaan stijgen.
