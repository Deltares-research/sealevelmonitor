...
|station|Geologische bodemdaling (mm/jaar)|
|------|-----|
|Den Helder|2.1|

: Trends per station {tbl-bodemdalingscomponenten}

![Geologische bodemdaling per 100 jaar](images/Totgeol100yr_nieuw.png){width=80%}{#fig-totgeol100yr}
