...
Op dit moment wordt een lineaire (\acr{LM}) of gegeneralizeerde lineaire modelfunctie (\acr{GLM}) gebruikt. In andere studies wordt ook wel een \acr{GAM} gebruikt. Het belangrijkste verschil is dat een GLM een vooraf gespecificeerde parametrische relatie tussen voorspellers en respons veronderstelt, terwijl een GAM deze relatie flexibel en niet-parametrisch uit de data schat.Dit verondersteld dat, al dan niet na transformatie, het model is terug te voeren op een lineair verband in de tijd. Hoewel dit .  In sommige andere studies worden niet-lineaire 
LOESS, GAM
