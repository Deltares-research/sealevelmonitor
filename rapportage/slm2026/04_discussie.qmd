...
### Verwijder jaren vóór 1950

Door alleen metingen vanaf 1950 mee te nemen in de analyse wordt het probleem van verschillen in variantie over de tijd omzeild. Er is nog een reden om de tijdserie in te korten. Oudere metingen zijn zijn onzekerder dan nieuwere. Dit heeft te maken met de frequentie van meten () en het feit dat de absolute verticale referentie van de zeespiegelmetingen vóór de invoering van nulpalen (1958) een grotere onzekerheid kende dan daarna.

Mogelijke nadelen zijn er ook. Door de tijdserie in te korten wordt mogelijk waardevolle informatie niet gebruikt. Ook kan het toelaten van een knikpunt onzekerder resultaten opleveren als deze dichter bij het begin van de tijdserie komt te liggen. Ook moet nagedacht worden hoe om te gaan als bijvoorbeeld het voorkeursmodel verandert bij het verkorten van de tijdserie.
...
### Het toevoegen van meer modellen

Op dit moment wordt een lineaire (\acr{LM}) of gegeneralizeerde lineaire modelfunctie (\acr{GLM}) gebruikt. In andere studies wordt ook wel een \acr{GAM} of \acr{LOESS} gebruikt (Keizer, ?). Het belangrijkste verschil is dat een GLM een vooraf gespecificeerde parametrische relatie tussen voorspellers en respons veronderstelt, terwijl een GAM deze relatie flexibel en niet-parametrisch uit de data schat. Een \GAM zou de variatie van de meetgegevens beter kunnen beschrijven wanneer een spline functie wordt toegevoegd. Deze betere beschrijving komt niet door een betere duiding van natuurkundige principes, maar door een hogere graad van vrijheid.

![Vergelijking GAM en "broken linear" model voor de Nederlandse zeespiegelmetingen.](https://github.com/Deltares-research/sealevelmonitor/raw/main/analysis/sealevelmonitor/gam-knmi-analyse_files/figure-gfm/unnamed-chunk-6-1.png)

![Vergelijking van de snelheid van zeespiegelstijging zoals geschat met het GAM model en het "broken linear" model.](https://github.com/Deltares-research/sealevelmonitor/raw/main/analysis/sealevelmonitor/gam-knmi-analyse_files/figure-gfm/plot-derivatives-1.png)
