...
- Het meten van de hoogte van het wateroppervlak ten opzichte van het middelpunt van de aarde of een zgn geoïde  (\@ref(fig:hoogtemetingen a)).
...
In 1993 begonnen de eerste altimetrie satelieten met meten. De eerste satelliet was Topex/Poseidon, gevolgd door Jason-1, Jason-2, Jason-3 en de Sentinel-6A/B satellieten [@Aviso2022Timeline]. In het begin van de metingen was de resolutie van de satellietmetingen beperkt tot 1 keer per 10 dagen.

Voor een nauwkeurige vergelijking met de in-situ metingen van de getijdestations is het nodig om de gemeten hoogtes ten opzichte van hetzelfde verticale referentievlak te bepalen. Satellietgegevens worden berekend ten opzichte van een gemiddeld niveau over een bepaalde periode (anomaliën), zonder informatie over het absolute referentieniveau. Op basis hiervan kunnen we alleen trends met elkaar vergelijken [@Stolte2022]. Daarom worden de gegevens meer ter verificatie gebruikt dan als primaire bron. We monitoren wel de wetenschappelijke ontwikkelingen op het gebied van satellietmetingen en de verwerking hiervan, om bij te houden of satellietdata ook een andere rol in de zeespiegelmonitor kan gaan spelen.

### Huidige zeespiegelstand berekend met gecombineerd satelliet product

De belangrijkste bron van satellietgegevens voor de zeespiegel is het gecombineerde product van meerdere satelieten. Om observaties van één missie voor de zeespiegelstand te gebruiken, zijn zowel de temporale als ruimtelijke resolutie te beperkt. Inmiddels is er vanaf 1993 tot heden een langere tijdreeks opgebouwd van het gecombineerde product. Echter, blijft het probleem van de beperkte kwaliteit bij de kust bestaan. Nieuwe technieken, bijvoorbeeld het toevoegen van SWOT (Surface Water Ocean Topography) hebben gezorgd voor een verkleining van die fout, maar voor de toepassing van de zeespiegelmonitor is deze onzekerheid nog te hoog.

In [@Stolte2022] wordt een vergelijking gemaakt met zeespiegelstand gemeten door satelieten met gebruik van de MEaSURE dataset, gedownload via de NASA Tool. Inmiddels kan er vanaf Copernicus Marine Services (CMEMS) een gecombineerd sateliet product gedownload. In het huidige CMEMS product kunnen lokale waterhoogtes nog met een onzekerheid van \~5 cm verschillen, de resolutie van het huidige CMEMS product ligt rond de 1/8 graden wat ongeveer overeenkomt met 7 km N-Z en \~4-5 km O-W rondom Nederland. Dit heeft ermee te maken dat het product gevalideerd wordt op de open oceaan [@CMEMS2024].

 Ter vergelijking zijn er twee reeksen geplot met het gecombineerde CMEMS product, een nabij IJmuiden en een nabij Vlissingen. De resultaten zijn weergegeven 4,6 mm/y Vlissingen, 3,9 mm/y IJmuiden.

![SSH Anomalie gecombineerd satellietproduct nabij Ijmuiden](https://github.com/Deltares-research/sealevelmonitor/blob/develop-reporting-dees/validation/satelllite/output/sea_surface_height_trend_ijmuiden.png?raw=true) ![SSH Anomalie gecombineerd satellietproduct nabij Vlissingen](https://github.com/Deltares-research/sealevelmonitor/blob/develop-reporting-dees/validation/satelllite/output/sea_surface_height_trend_vlissingen.png?raw=true)

### Verwachting voor de toekomst en toepassing voor zeespiegelmonitor

Het voortzetten van de satelietmeetreeks en het verbeteren van kwaliteit nabij de kust zijn de belangrijkste punten om het gebruik van satelietgegevens in de zeespiegelmonitor te vergroten [@Aviso2022Timeline] [@Ballarotta2022]. In de toekomst zal de lancering van het Sentinel-3 Next Generation (S3NG-T) programma een belangrijke rol spelen in het verbeteren van de kwaliteit van de metingen in kustgebieden. Deze satellieten zullen de klassieke altimetrie combineren met een vergelijkbare sensor als SWOT, daarnaast is het doel om een 5-day revisit periode te realiseren en een ruimtelijke resolutie van 50 km te bereiken. [link](https://lps25.esa.int/lps25-presentations/presentations/329/_329.pdf),, [link](https://database.eohandbook.com/database/missionsummary.aspx?missionID=1469) Echter zijn deze ontwikkelingen nog in de startfase, met verschillende verwachtingen van lanceringsdatum (2030-2034), tot die tijd is de voortzetting van de huidige satelietmeetreeks het belangrijkste punt.
