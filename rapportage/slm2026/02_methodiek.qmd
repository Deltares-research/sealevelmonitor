...
<placeholder> tekst uit infographics:::{fig-gnssmetingen}

![Hoogtemeting van het meetinstrument in de getijdestations met GNSS](images/gnss_satelliet.png){width=60%}
...
Hoogtemetingen in de kustzone. (a) Directe metingen van het zeeoppervlak met behulp van satellietaltimetrie en (b) hoogtemeting van het meetinstrument in de getijdestations met GNSS.
:::

### Beschikbare satellieten en metingen

![Tijdlijn van satellieten vanaf 1993 tot 2030 \[\@Aviso2022Timeline\]](images/TimelineAltimetry_v202504.png)
...
## Zeespiegelprojecties

<Dewi? 

Short descriptiono on projections, source and references. Link to results section (@sec-scenarios)
