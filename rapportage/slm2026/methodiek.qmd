...
De maand- en jaargemiddelden zijn op dit moment (februari 2026) preliminair uitgerekend, maar zijn nog niet aangeleverd aan {PSMSL}.

<placeholder> consequenties voor zeespiegel, zss en keuze stations uitleggen (maar pas toepassen als gegevens in PSMSL staan)

## Rekenmethode voor GTSM windopzet correctie in de Zeespiegelmonotor
...
Voor de windopzetcorrectie van de jaargemiddelde zeespiegelstanden worden de \acr{GTSM} windopzet maandgemiddelden eerst gemiddeld per jaar en station, Daarna wordt de windopzet afgetrokken van de gemiddelde zeespiegel om tot een gecorrigeerde zeespiegel per jaar per hoofdstation te komen. Voor het gemiddelde over Nederland worden de gecorrigeerde waarden gemiddeld over de stations.
