...
# Van meting naar zeespiegelverandering {#infographicstext}
...
De gemeten waterstand wordt gerefereerd aan een diepgefundeerde paal, de nulpaal of een ander \acr{NAP}-peilmerk. Voor de hoofdgetijdenstations gaat het doorgaans om de M-bout die in de muur van het station is bevestigd. Het hoogtesysteem in Nederland is gedefinieerd ten opzichte van het \acr{NAP}. Met ‘het \acr{NAP}’ wordt het \acr{NAP}-nulvlak bedoeld. Het \acr{NAP}-nulvlak wordt in de praktijk vastgelegd door middel van zes ondergrondse peilmerken, op de zandgronden van Midden-Nederland, die stabiel worden verondersteld. Daarnaast zijn er \acr{NAP}-peilmerken, bronzen bouten bevestigd aan gebouwen, bruggen en viaducten, waarvan het hoogteverschil met het denkbeeldige \acr{NAP}-nulvlak bekend is. Hierdoor ontstaat een samenhangende set van peilmerken waarvan de \acr{NAP}-hoogte bekend verondersteld is, ons referentiesysteem. Er zijn twee typen \acr{NAP}-peilmerken, primaire en secundaire merken, dit wordt nader toegelicht op pagina 4 van deze infographic. De primaire peilmerken zijn stabieler omdat deze meestal gefundeerd zijn in het Pleistoceen.
...
De \acr{NAP}-peilmerken werden voorheen per regio 1x per 10 jaar ingemeten (ook wel de A0-controle/correctie genoemd), in wat ook wel ‘planperiodes’ genoemd worden. Alleen de minder stabiele locaties (Groningen en Friesland) werden 1x per 5 jaar ingemeten. Deze metingen werden voor zowel de primaire en secundaire peilmerken uitgevoerd en de informatie werd ontsloten in de \acr{NAP}-info viewer en via webservices. De vaste cycli van 5 of 10 jaar zijn losgelaten, omdat er nu geprioriteerd wordt op basis van deformatiekaarten.

Ten slotte zijn er de nauwkeurigheidswaterpassingen (NWP’s); dit zijn de landelijke waterpassingen. Bij de \acr{NWP}’s wordt de hoogte van primaire landelijke punten t.o.v. het \acr{NAP}-nulvlak vastgelegd. Deze \acr{NWP}’s vinden niet met een reguliere frequentie plaats, maar zijn altijd uitgevoerd vanwege een specifieke aanleiding. Er zijn tot nu toe vijf \acr{NWP}’s uitgevoerd. In de programmering wordt een volgende \acr{NWP} opgenomen, maar hiervoor staat de timing nog niet vast. De aanleiding voor deze \acr{NWP} is een gewenste controle van de primaire merken en in verband met de aansluiting bij Europese referentiesystemen, om betere omrekening mogelijk te maken door dit te combineren met GNSS-metingen. Naar aanleiding van de 5^e^ \acr{NWP} zijn de volgende correcties voor de hoofdgetijdenstations doorgevoerd in 2005: Delfzijl -8,2 mm; Den Helder -16,8 mm; Harlingen -6,5 mm; Hoek van Holland -6,5 mm; IJmuiden -21,5 mm en Vlissingen -29,7 mm.

## Geologische bodemdaling en GNSS-metingen

Een alternatieve methode voor het monitoren van de bodembeweging bij hoofdgetijdenstation is middels Global Navigation Satellite System (GNSS) stations. Voor monitoring van de bodembeweging van een GNSS-antenne bij een hoofdgetijdenstation is geen transformatie nodig, omdat de referentiehoogte voor het vergelijken van hoogtes op twee tijdstippen niet uitmaakt. Wel is het relevant of de GNSS-antenne en het waterstandsmeetinstrument dezelfde bodembeweging vertonen. Hiervoor is het nodig om zowel de \acr{NAP}-hoogte van de GNSS-antenne en het waterstandsmeetinstrument herhaaldelijk te vergelijken met de hoogte van de nulpaal, waarvan bekend is dat deze in het Pleistoceen gefundeerd zijn. Om eventuele verzakkingen van de GNSS-antenne zo goed mogelijk in beeld te brengen zijn bij de getijdenstations met GNSS-apparatuur ook extra muurbouten geplaatst. Op deze manier kunnen eventuele ongelijkheden in zakkingen (scheefstand) bij een getijdenstation in kaart worden gebracht. Met behulp van waterpassing en tachymetrie kan jaarlijks de precieze hoogte ten opzichte van het \acr{NAP}-nulvlak worden bepaald (lokale deformatie) voor zowel het peilmerk en de GNSS-antenne. Deze jaarlijkse meting staat los van de B0-meting, aangezien niet dezelfde apparatuur gebruikt wordt en niet dezelfde mensen de metingen uitvoeren.
...
[\[2\]](#_ftnref2) Hijma (2019). Bodemdalingsmonitor 2019 Kustfundament en getijdenbekkens - \acr{NAP}-peilmerkenanalyse, monitoringsstrategie, isostatische modellen
...
# Vragen aan de Zeespiegelmonitor
