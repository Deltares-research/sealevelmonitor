...
Sea level analysis of the six main tide stations in the Netherlands is presented in this [document](https://github.com/Deltares-research/sealevelmonitor/blob/main/analysis/sealevelmonitor/10_sealevelanalysis.md). In the document the following steps are taken:
...
Sea Level Monitor [document](https://github.com/Deltares-research/sealevelmonitor/blob/main/analysis/sealevelmonitor/20_sealevelmonitor.md) presents the results for an average of the Dutch stations, using the preferred model (from Sea Level Analysis)
