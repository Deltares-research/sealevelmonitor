...
|-----:|-------------:|:-------------------------------|
| 2025 |        112.4 | Netherlands (without Delfzijl) |
...
<figure>
<img src="20_sealevelmonitor_files/figure-gfm/autocorrelatie-1.png"
...
<img src="20_sealevelmonitor_files/figure-gfm/unnamed-chunk-1-1.png" alt="De verdeling (histogram) van de residuen. "  />
<p class="caption">
...
<figure>
<img
src="20_sealevelmonitor_files/figure-gfm/variation-model-time-1.png"
...
<figure>
<img src="20_sealevelmonitor_files/figure-gfm/unnamed-chunk-2-1.png"
...
<figure>
<img src="20_sealevelmonitor_files/figure-gfm/partials-1.png"
alt="Bijdrage van de verschillende componenten aan de totale zeespiegel aan de Nederlandse kust. De bijdrage van windopzet (surge_anomaly) is apart berekend met GTSM. De bijdrage van het nodaal getij (nodal_fit) is geschat met het regressiemodel. De bijdragen van windopzet, nodaal getij en residu zijn kunstmatig verlaagd in de grafiek voor de presentatie. In het echt zijn hun bijdragen gecentreerd rond nul." />
<figcaption aria-hidden="true">Bijdrage van de verschillende componenten
aan de totale zeespiegel aan de Nederlandse kust. De bijdrage van
windopzet (surge_anomaly) is apart berekend met GTSM. De bijdrage van
het nodaal getij (nodal_fit) is geschat met het regressiemodel. De
bijdragen van windopzet, nodaal getij en residu zijn kunstmatig verlaagd
in de grafiek voor de presentatie. In het echt zijn hun bijdragen
gecentreerd rond nul.</figcaption>
</figure>
...
![](20_sealevelmonitor_files/figure-gfm/unnamed-chunk-4-1.png)<!-- -->
...
![](20_sealevelmonitor_files/figure-gfm/unnamed-chunk-5-1.png)<!-- -->
...
![](20_sealevelmonitor_files/figure-gfm/unnamed-chunk-6-1.png)<!-- -->
...
output <- "## Uitspraken over de zeespiegel trend \n\n"

output = paste0(output, "\nDe volgende uitspraken gelden voor berekeningen gedaan aan het virtuele station ", params$station, " en het voorkeursmodel ", params$modeltype, ".", " De analyse houdt rekening met wind en nodaal getij. \n\n")

if(params$modeltype == "broken_linear"){
  trend_message = paste0(
    output,
    paste("\n\nDe lineaire trend tot 1993 bedraagt", 
          ...
          "mm/jaar."),
    paste("\n\nDe extra trend na 1993 bedraagt", 
          ...
          "mm/jaar."),
    paste("\n\nNa 1993 is de totale trend verhoogd en bedraagt", 
...
if(params$modeltype == "broken_squared"){
  ...
  trend_message = paste0(
    output,
    paste("\n\nDe lineaire trend tot 1960 bedroeg", 
          Trend, " +/- ", SE_trend, "mm/jaar."),
    paste("\n\nDe extra trend na 1960 is stijgende en bedroeg in het jaar ", params$monitoryear - 1, 
         `+trend_current`, " +/- ", `SE_+trend_current`, "mm/jaar."),
    paste("\n\nNa 1960 is de totale trend ook stijgende en bedroeg in het jaar ", config$runparameters$monitoryear - 1, 
