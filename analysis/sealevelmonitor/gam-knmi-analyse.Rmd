...
- Official Sea Level Monitor uses GLM variants
- Others (KNMI) use GAM to estimate SLR
- SLM reproduces GAM analysis for comparison and to visualize patterns (explorative)
