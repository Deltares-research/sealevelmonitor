...
# df <- readSeaLevelData(file.path("../", config$constants$dataUrl)) %>%
  df <- read_csv2(file.path("../", "../data/deltares/results/dutch-sea-level-monitor-export-stations-2023-11-20_temp.csv")) %>%
  filter(
...
cat(
  "For wind upset,", params$wind_or_surge_type, "is used"
)
