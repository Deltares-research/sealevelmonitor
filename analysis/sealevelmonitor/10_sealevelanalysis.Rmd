...
```{r prediction-plot_preferred-model, eval=T, fig.height=5, fig.width=8, fig.cap= "Observed and predicted sea level for all main stations and the preferred model. "}
...
```{r prediction-plot_preferred-model2, eval=T, fig.height=3, fig.width=8, fig.cap= "Observed and predicted sea level for averaged station and the preferred model. "}
