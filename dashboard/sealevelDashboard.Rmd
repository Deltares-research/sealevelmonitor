...
fillPage(
  fillCol(height = "80%", flex = c(NA,1), 
          h3("Observed (monitoring) and projected (modelled) sea level at the Dutch coast, in cm"),  
...
output$stationPlot <- renderPlotly({
  ...
  p <- sealevelAllStations %>% 
    ...
    geom_line(aes(year, `observed_minus_surge_effect in cm`, color = StationName)) +
